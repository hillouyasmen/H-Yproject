...
// POST /api/contact — استقبال رسالة
router.post("/", async (req, res, next) => {
  try {
    ...
    emitEvent("contact.new", { id: r.insertId, name, email, subject });
...
// GET /api/contact?status=open|resolved — (أدمن فقط)
...
// PUT /api/contact/:id — تحديث الحالة/ملاحظة (أدمن)
