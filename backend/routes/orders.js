...
router.post('/', async (req, res) => {
  ...
  const { user_id, total_amount, status, items, shipping_address, payment_method, customer_name, customer_email, customer_phone } = req.body;
  ...
  try {
    ...
    const userEmail = req.user?.email; // Assuming user email is in the JWT
    if (userEmail) {
