...
export default function Invoice() {
  ...
  const [toEmail, setToEmail] = useState(""); // اختياري
  ...
  const sendToEmail = async () => {
    try {
      setSending(true);
      // لو كتبت بريد هنا، بنبعثه؛ لو تركته فاضي، السيرفر بيستخدم بريد الحساب من DB
      await api.post(`/orders/${order.order_id}/send-invoice`, {
        ...(toEmail ? { to: toEmail } : {}),
      });
